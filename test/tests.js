(function($){
	$(document).ready(function(){
		...
		QUnit.test("It passes complex encoding tests", function(assert){
			...
			enigma = new EnigmaMachine([['Beta', 4, 19], ['IV', 6, 23], ['VIII', 16, 2], ['II', 13, 11]], 'C Thin', ['AT', 'BP', 'CY', 'EO', 'FX', 'HI', 'JS', 'KL', 'MZ', 'UV']);
			assert.equal(enigma.cipher('THEQUICKBROWNFOXJUMPEDOVERTHELAZYBROWNDOG'), 'BPVJRKDUZEZVOTYZNYCEDAZJQPSRKURPRXKDTZBGV', "Enigma with rotor set Beta ground 4 ring 19, IV ground 6 ring 23, VIII ground 16 ring 2, II ground 13 ring 11, reflector C Thin and plugboard A<>T, B<>P, C<>Y, E<>O, F<>X, H<>I, J<>S, K<>L, M<>Z, U<>Z encodes THEQUICKBROWNFOXJUMPEDOVERTHELAZYBROWNDOG to BPVJRKDUZEZVOTYZNYCEDAZJQPSRKURPRXKDTZBGV");
			enigma = new EnigmaMachine([['Beta', 4, 19], ['IV', 6, 23], ['VIII', 16, 2], ['II', 13, 11]], 'C Thin', ['AT', 'BP', 'CY', 'EO', 'FX', 'HI', 'JS', 'KL', 'MZ', 'UV']);
			assert.equal(enigma.cipher('BPVJRKDUZEZVOTYZNYCEDAZJQPSRKURPRXKDTZBGV'), 'THEQUICKBROWNFOXJUMPEDOVERTHELAZYBROWNDOG', "Enigma with rotor set Beta ground 4 ring 19, IV ground 6 ring 23, VIII ground 16 ring 2, II ground 13 ring 11, reflector C Thin and plugboard A<>T, B<>P, C<>Y, E<>O, F<>X, H<>I, J<>S, K<>L, M<>Z, U<>Z encodes BPVJRKDUZEZVOTYZNYCEDAZJQPSRKURPRXKDTZBGV to THEQUICKBROWNFOXJUMPEDOVERTHELAZYBROWNDOG");
		});	
